...
I have also used luxon library for formatting of date and time into more readable form.

To run project just clone the project and run npm start.

The project is also live at https://plabroo.github.io/weather-app-react/
